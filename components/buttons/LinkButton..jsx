export const LinkButton = ({ size, icon, href, className = "", borderVariant="normal", ...props }) => (
  <a
    href={href}
    {...props}
    className={`hide-cursor group relative ${size == "sm" ? "w-8 md:w-12" : "w-12 md:w-16"} aspect-square rounded-full 
  ...
  >
    ...
    {icon && (
      <i
        className={`${icon} ${size == "sm" ? "text-sm md:text-md" : "text-md md:text-xl"} relative z-10 
